...
public class ZooInjectorProvider implements IInjectorProvider, IRegistryConfigurator {
	...
	public Injector getInjector() {
		if (injector == null) {
			this.injector = new ZooStandaloneSetup().createInjectorAndDoEMFRegistration();
		}
		return injector;
	}
