...
public class OperatorsTestInjectorProvider implements IInjectorProvider, IRegistryConfigurator {
	...
	public Injector getInjector() {
		if (injector == null) {
			this.injector = new OperatorsTestStandaloneSetup().createInjectorAndDoEMFRegistration();
		}
		return injector;
	}
