package gpp.tests.operators.boxmodel;
...
@Singleton
public class OperatorsTestBoxModelProvider implements IBoxModelProvider
{
	private final static String BOX_MODEL_STORAGE = "/src-gen/gpp/tests/operators/boxmodel/OperatorsTestBoxModel.xmi";
