 ...
 * <ul>
 *   <li>{@link gpp.tests.operators.operatorsTest.impl.IntConstantImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IntConstantImpl extends ConstantImpl implements IntConstant
{
  ...
  {
    return OperatorsTestPackage.Literals.INT_CONSTANT;
  }
  ...
  public void setValue(int newValue)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OperatorsTestPackage.INT_CONSTANT__VALUE, oldValue, value));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case OperatorsTestPackage.INT_CONSTANT__VALUE:
        return getValue();
    }
