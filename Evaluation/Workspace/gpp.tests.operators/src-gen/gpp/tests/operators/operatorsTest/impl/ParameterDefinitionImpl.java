 ...
 * <ul>
 *   <li>{@link gpp.tests.operators.operatorsTest.impl.ParameterDefinitionImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ParameterDefinitionImpl extends MinimalEObjectImpl.Container implements ParameterDefinition
{
  ...
  {
    return OperatorsTestPackage.Literals.PARAMETER_DEFINITION;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OperatorsTestPackage.PARAMETER_DEFINITION__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case OperatorsTestPackage.PARAMETER_DEFINITION__NAME:
        return getName();
    }
